...
import styles from './Coped.module.scss'
...
function Coped() {
    ...
    <div className={cx('Container') }>
       <div className={cx('header')}>
        ...
        <button className={cx('button')}>Chốt đối soát </button>
       ...
       <div className={cx('grow__2-text__1')}>1</div>
                ...
                <div className={cx('grow__2-text__7')}> Chưa đối soát</div>
       </div>
       <div className={cx('content--3__row')}>
        ...
        <div className={cx('grow__3-text__7')}>Chưa đối soát</div>
       ...
       <div className={cx('grow__4-text__1')}>3</div>
                ...
                <div className={cx('grow__4-text__7')}>Chưa đối soát</div>
       ...
       <div className={cx('grow__5-text__1')}>4</div>
        ...
        <div className={cx('grow__5-text__7')}>Chưa đối soát </div>
